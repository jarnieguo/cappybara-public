...
public class KaldiActivity extends Activity implements
    ...
    public void onCreate(Bundle state) {
        ...
        String vuriString = intent.getStringExtra(EditorActivity.AUDIO_URI);
        audioUri = Uri.parse(vuriString);
    ...
    private static class RecognizeTask extends AsyncTask<Void, Void, String> {
        ...
        RecognizeTask(KaldiActivity activity, TextView resultView, InputStream is) {
            this.activityReference = new WeakReference<>(activity);
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                InputStream ais = activityReference.get().getAssets().open("lid.wav");
                ais = is;
    ...
    try {
        ...
        InputStream in = cr.openInputStream(audioUri);

        new RecognizeTask(this, resultView, in).execute();
    } catch(Exception e) {
        Log.d("uh", e.toString());
    }
