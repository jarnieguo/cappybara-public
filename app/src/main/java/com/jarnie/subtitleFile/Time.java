...
public class Time {
    ...
    // ADDED
	// Constructor that takes pure mseconds
	public Time(int ms) {
    	mseconds = ms;
	}

	// ADDED
	// Static method to translate "hh:mm:ss.cs" format time to mseconds
	public static final int STRING_LEN = 11;
	public static int stringToMs(String value) {
		int h, m, s, cs;
		String[] hms = value.split(":");
		h = Integer.parseInt(hms[0]);
		m = Integer.parseInt(hms[1]);
